...
// Set base URL, pastikan sesuaikan nama folder (misal candycbt)
$base_folder = "candycbt"; // <- Ubah ini sesuai nama folder Anda
$homeurl = "http://" . $_SERVER['HTTP_HOST'] . "/" . $base_folder;
